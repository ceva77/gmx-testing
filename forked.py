...
# custom minting logic for Arbitrum tokens

def mint_0xfc5A1A6EB076a2C7aD06eD22C90d7E710E35ad0a(
    token: MintableForkToken, target: str, amount: int
) -> None:
    # GMX
    gov = '0x68863dde14303bced249ca8ec6af85d4694dea6a'
    token.mint(target, amount, {'from': gov})


def mint_0xf42Ae1D54fd613C9bb14810b0588FaAa09a426cA(
    token: MintableForkToken, target: str, amount: int
) -> None:
    # esGMX
    gov = '0x3f3e77421e30271568ef7a0ab5c5f2667675341e'
    token.setMinter(target, True, {'from': gov})
    token.mint(target, amount, {'from': target})


def mint_0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8(
    token: MintableForkToken, target: str, amount: int
) -> None:
    # USDC
    gateway = '0x096760f208390250649e3e8763348e783aef5562'
    token.bridgeMint(target, amount, {'from': gateway})
